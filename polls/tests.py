...
class QuestionModelTest(TestCase):
    def test_was_published_recently_with_old_question(self):
        ...
        for questions whose pub_date is older than a day."""
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question(self):
        """
        Questions with a pub_date in the future aren't displayed o the index page.
        """
...
class QuestioDetailViewTest(TestCase):
    def test_future_question(self):
        """
